...
from data import AnnotationTransform, COCODetection, VOCDetection, BaseTransform, VOC_320,VOC_512,COCO_300,COCO_512, COCO_mobile_300
...
parser.add_argument('-v', '--version', default='AFSSD',
                    help='AFSSD.')
parser.add_argument('-s', '--size', default='320',
                    help='320 or 512 input size.')
parser.add_argument('-d', '--dataset', default='VOC',
                    help='VOC or COCO version')
parser.add_argument('-m', '--trained_model', default='weights/AFSSD_VOC_epoches_292.pth',
...
if args.version == 'AFSSD':
    from models.AFSSD import build_net
else:
...
def test_net(save_folder, net, detector, cuda, testset, transform, max_per_image=300, thresh=0.005):
    ...
    print('Evaluating detections')
    testset.evaluate_detections(all_boxes, save_folder)
    print('FPS: {:.3f} fps'.format((num_images - 1) / a))
    print(b)
    print(a)
